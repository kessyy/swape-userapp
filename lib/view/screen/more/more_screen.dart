        ...
        Positioned(
          ...
          child: Consumer<ProfileProvider>(
            builder: (context, profile, child) {
              return Row(children: [
                Image.asset(Images.splash_logo, height: 35, color: ColorResources.BLACK),
                ...
                InkWell(
                  ...
                  child: Row(children: [
                    Text(!isGuestMode ? profile.userInfoModel != null ? '${profile.userInfoModel.fName} ${profile.userInfoModel.lName}' : 'Full Name' : 'Guest',
                        style: titilliumRegular.copyWith(color: ColorResources.BLACK)),
        ...
        Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              TitleButton(image: Images.more_image, title: ('All categories'), navigateTo: AllCategoryScreen()),
              TitleButton(image: Images.notification, title: getTranslated('notification', context), navigateTo: NotificationScreen()),
              //TODO: seller
              TitleButton(image: Images.message_image, title: getTranslated('chats', context), navigateTo: InboxScreen()),
              ...
              TitleButton(image: Images.faq, title: getTranslated('faq', context), navigateTo: FaqScreen(
              ...
              ListTile(
                leading: Image.asset(Images.about_us, width: 25, height: 25, fit: BoxFit.fill, color: ColorResources.getPrimary(context)),
