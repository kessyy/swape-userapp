...
import 'package:swape_user_app/view/basewidget/search_widget.dart';
import 'package:swape_user_app/view/screen/chat/top_seller_chat_screen.dart';
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      fit: BoxFit.cover,
                      image:
                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls.shopImageUrl}/${topSeller.banner != null ? topSeller.banner : ''}',
