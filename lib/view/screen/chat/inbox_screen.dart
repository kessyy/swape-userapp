      ...
      body: Column(children: [
        ...
        Stack(children: [
          ClipRRect(
            ...
            child: Image.asset(
              Images.toolbar_background, fit: BoxFit.fill, height: 70, width: double.infinity,
              color: Colors.white,
            ),
          ),
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Provider.of<ChatProvider>(context).isSearching
                  ...
                  style: titilliumSemiBold.copyWith(color: ColorResources.BLACK, fontSize: Dimensions.FONT_SIZE_LARGE),
                  ...
                  style: titilliumRegular.copyWith(fontSize: 20, color: ColorResources.BLACK),
                  maxLines: 1,
