  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(getTranslated('all_brand', context), style: titilliumRegular.copyWith(fontSize: 20, color: ColorResources.BLACK)),
        actions: [
          PopupMenuButton(
          itemBuilder: (context) {
            return [
              PopupMenuItem(enabled: false, child: Text(getTranslated('sort_by', context), style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: ColorResources.BLACK))),
          ...
          child: Padding(
            ...
            child: Image.asset(Images.filter_image, color: ColorResources.BLACK),
          ),
          onSelected: (value) {
