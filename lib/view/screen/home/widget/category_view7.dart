...
class CategoryView7 extends StatelessWidget {
  final bool isHomePage;
  CategoryView7({@required this.isHomePage});
        ...
        return categoryProvider.categoryList.length != 0
            ? GridView.builder(
                ...
                itemCount: isHomePage
                    ? categoryProvider.categoryList[6].subCategories.length > 10
                        ? 10
                        : categoryProvider.categoryList[6].subCategories.length
                    : categoryProvider.categoryList[6].subCategories.length,
                shrinkWrap: true,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => BrandAndCategoryProductScreen(
                                  isBrand: false,
                                  id: categoryProvider
                                      .categoryList[6].subCategories[index].id
                                      .toString(),
                                  name: categoryProvider.categoryList[6]
                                  ...
                                  child: Center(
                                    child: Text(
                                      categoryProvider.categoryList.length != 0
                                          ? categoryProvider.categoryList[6]
                                              .subCategories[index].name
                                ...
                                child: ClipRRect(
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    image:
                                        ...
                                        '/${categoryProvider.categoryList[6].subCategories[index].icon}',
