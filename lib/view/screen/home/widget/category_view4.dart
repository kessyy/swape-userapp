...
class CategoryView4 extends StatelessWidget {
  final bool isHomePage;
  CategoryView4({@required this.isHomePage});
        ...
        return categoryProvider.categoryList.length != 0
            ? GridView.builder(
                ...
                itemCount: isHomePage
                    ? categoryProvider.categoryList[3].subCategories.length > 10
                        ? 10
                        : categoryProvider.categoryList[3].subCategories.length
                    : categoryProvider.categoryList[3].subCategories.length,
                shrinkWrap: true,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => BrandAndCategoryProductScreen(
                                  isBrand: false,
                                  id: categoryProvider
                                      .categoryList[3].subCategories[index].id
                                      .toString(),
                                  name: categoryProvider.categoryList[3]
                                  ...
                                  child: Center(
                                    child: Text(
                                      categoryProvider.categoryList.length != 0
                                          ? categoryProvider.categoryList[3]
                                              .subCategories[index].name
                                ...
                                child: ClipRRect(
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    image:
                                        ...
                                        '/${categoryProvider.categoryList[3].subCategories[index].icon}',
