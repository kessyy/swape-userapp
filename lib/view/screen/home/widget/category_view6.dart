...
class CategoryView6 extends StatelessWidget {
  final bool isHomePage;
  CategoryView6({@required this.isHomePage});
        ...
        return categoryProvider.categoryList.length != 0
            ? GridView.builder(
                ...
                itemCount: isHomePage
                    ? categoryProvider.categoryList[5].subCategories.length > 10
                        ? 10
                        : categoryProvider.categoryList[5].subCategories.length
                    : categoryProvider.categoryList[5].subCategories.length,
                shrinkWrap: true,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => BrandAndCategoryProductScreen(
                                  isBrand: false,
                                  id: categoryProvider
                                      .categoryList[5].subCategories[index].id
                                      .toString(),
                                  name: categoryProvider.categoryList[5]
                                  ...
                                  child: Center(
                                    child: Text(
                                      categoryProvider.categoryList.length != 0
                                          ? categoryProvider.categoryList[5]
                                              .subCategories[index].name
                                ...
                                child: ClipRRect(
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    image:
                                        ...
                                        '/${categoryProvider.categoryList[5].subCategories[index].icon}',
