  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BrandProvider>(
      builder: (context, brandProvider, child) {
        ...
        return brandProvider.brandList.length != 0 ? isHomePage?
        ConstrainedBox(
          constraints: brandProvider.brandList.length > 0 ? BoxConstraints(maxHeight: 110):BoxConstraints(maxHeight: 0),
          child: ListView.builder(
              ...
              itemBuilder: (ctx,index){
                return InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => BrandAndCategoryProductScreen(isBrand: true,
                  id: brandProvider.brandList[index].id.toString(),
                  name: brandProvider.brandList[index].name,
                  image: brandProvider.brandList[index].image,)));
                  },
