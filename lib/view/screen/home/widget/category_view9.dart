...
class CategoryView9 extends StatelessWidget {
  final bool isHomePage;
  CategoryView9({@required this.isHomePage});
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => BrandAndCategoryProductScreen(
                                  isBrand: false,
                                  id: categoryProvider
                                      .categoryList[8].subCategories[index].id
                                      .toString(),
                                  name: categoryProvider.categoryList[8]
                                  ...
                                  child: Center(
                                    child: Text(
                                      categoryProvider.categoryList.length != 0
                                          ? categoryProvider.categoryList[8]
                                              .subCategories[index].name
                                ...
                                child: ClipRRect(
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    image:
                                        ...
                                        '/${categoryProvider.categoryList[8].subCategories[index].icon}',
