...
class CategoryView2 extends StatelessWidget {
  ...
  CategoryView2({@required this.isHomePage});
        ...
        return categoryProvider.categoryList.length != 0
            ? GridView.builder(
                ...
                itemCount: isHomePage
                    ? categoryProvider.categoryList[1].subCategories.length > 10
                        ? 10
                        : categoryProvider.categoryList[1].subCategories.length
                    : categoryProvider.categoryList[1].subCategories.length,
                shrinkWrap: true,
                                  ...
                                  child: Center(
                                    child: Text(
                                      categoryProvider.categoryList.length != 0
                                          ? categoryProvider.categoryList[1]
                                              .subCategories[index].name
