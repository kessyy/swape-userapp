                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        SizedBox(width: 10),
                        Text(getTranslated('PROFILE', context), style: titilliumRegular.copyWith(fontSize: 20, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                      ]),
                    ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            Icon(Icons.dialpad, color: ColorResources.getPrimary(context), size: 20),
                                            SizedBox(width: Dimensions.MARGIN_SIZE_EXTRA_SMALL),
