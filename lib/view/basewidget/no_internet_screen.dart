        ...
        child: Column(
          ...
          children: [
            ...
            Text(isNoInternet ? getTranslated('OPPS', context) : getTranslated('sorry', context), style: titilliumBold.copyWith(
              fontSize: 30,
              color: isNoInternet ? Theme.of(context).textTheme.bodyText1.color : ColorResources.getTextTitle(context),
            )),
            ...
            isNoInternet ? Container(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: ColorResources.getTextTitle(context)),
              child: TextButton(
                onPressed: () async {
