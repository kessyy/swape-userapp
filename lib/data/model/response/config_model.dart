...
class BaseUrls {
  ...
  BaseUrls(
    ...
    this._subcategoryImageUrl = subcategoryImageUrl;
  ...
  String get subcategoryImageUrl => _subcategoryImageUrl;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _subcategoryImageUrl = json['subcategory_image_url'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['subcategory_image_url'] = this._subcategoryImageUrl;
