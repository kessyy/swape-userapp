...
import 'package:swape_user_app/data/model/response/home_category_product_model.dart';
import 'package:swape_user_app/data/repository/home_category_product_repo.dart';
...
class HomeCategoryProductProvider extends ChangeNotifier {
  ...
  Future<void> getHomeCategoryProductList(
    ...
    if (_homeCategoryProductList.length == 0 || reload) {
      ApiResponse apiResponse = await homeCategoryProductRepo
          .getHomeCategoryProductList(languageCode);
